        ...
        for (var d = 0; d < controlFields.dropDownFields.length; d++) {
            ...
            try {
                ...
                var _defaultOpts = {
                    ...
                    valField: '', textField: '', error: controlFields.dropDownFields[d].Label,
                    cache: false
                };

                var ddInfo = $.evalJSON(controlFields.dropDownFields[d].DropDownInfo);
                _defaultOpts.sortByField = ddInfo.textField;
                if (ddInfo.sortBy != null && ddInfo.sortBy != '') {
                    _defaultOpts.sortByField = ddInfo.sortBy;
                }

                var _options = $.extend(_defaultOpts, ddInfo);
